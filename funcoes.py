...
def apagar_pycache():#TODO : trocar pelo pc do user
    caminho = r'C:\\Users\\USUARIO\\Desktop\\automacao_descritivo_laudo\\'
...
def substituir_indices_4_e_5(lista_tuplas, lista_valores_4, lista_valores_5):
    ...
    if len(lista_tuplas) != len(lista_valores_4):
        print(f'{DARK_RED}os valores de mercado não batem{RESET}')
        return lista_tuplas
    if len(lista_tuplas) != len(lista_valores_5):
        print(f'{DARK_RED}os valores de liquidação não batem{RESET}')
        return lista_tuplas
